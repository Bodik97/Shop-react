...
export default function Faq({ q, a }) {
  return (
    <details className="group py-4 cursor-pointer transition">
      <summary className="flex items-center justify-between text-[15px] sm:text-base font-semibold text-ink">
        <span>{q}</span>
        <span
      ...
      <p
        className="mt-3 text-ink-soft text-[14px] sm:text-[15px] leading-relaxed
