        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-white">
              ...
              Постанови Кабінету Міністрів України №576 від 12.10.1992 року
              Наказ МВС України №622
              нормативних актів Міністерство внутрішніх справ України

              вироби даного типу:

              ✔️ не відносяться до категорії вогнепальної зброї
              ✔️ не підлягають обов’язковій реєстрації
              ✔️ не потребують отримання спеціальних дозволів для придбання

              Товар призначений виключно для:

              спортивно-тренувального використання
              розважальних та сигнальних цілей

              Продаж здійснюється особам, які досягли 18-річного віку.

              ❗️ Важливо:
              Використання виробу повинно здійснюватися з дотриманням чинного законодавства України та норм громадського порядку.
            </p>
          </div>
